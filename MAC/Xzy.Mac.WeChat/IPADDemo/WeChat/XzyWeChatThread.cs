...
using MacDemo.AppData;
using Xzy.Mac.Core;

namespace MacDemo.WeChat
{
    public class XzyWeChatThread
    {
        ...
        public unsafe void Init()
        {
            fixed (int* WxUser1 = &pointerWxUser, pushStr1 = &pushStr)
            {
                ...
                if (QRCodejson.Status == 2)
                {
                    ...
                    XzyWxApis.WXQRCodeLogin(pointerWxUser, username, pass, (IntPtr)pushStr1);
                    var datas = MarshalNativeToManaged((IntPtr)pushStr);
                    string sstr = datas.ToString();
                    Wx_ReleaseEX(ref pushStr);
            ...
            fixed (int* WxUser1 = &pointerWxUser, pushStr1 = &pushStr)
            {
                ...
                if (userData.Status == -301)
                {
                    ...
                    if (userData.Status == 0)
                    {
                        ...
                        //：登录成功后，取出token备用
                        XzyWxApis.WXGetLoginToken(pointerWxUser, (IntPtr)pushStr1);
        ...
        public unsafe string Wx_SendImg(string wxid, string imgpath)
        {
            ...
            fixed (int* WxUser1 = &pointerWxUser, imptr1 = &wx_imptr)
            {
                ...
                XzyWxApis.WXSendImage(pointerWxUser, wxid, data, data.Length, (IntPtr)imptr1);
        ...
        public unsafe string Wx_SendVoice(string wxid, string silkpath, int time)
        {
            ...
            fixed (int* WxUser1 = &pointerWxUser, imptr1 = &wx_imptr)
            {
                try
                {
                    ...
                    if (data.Length > 0)
                    {
                        XzyWxApis.WXSendVoice(pointerWxUser, wxid, data, data.Length, time * 1000, (IntPtr)imptr1);
                        var datas = MarshalNativeToManaged((IntPtr)wx_imptr);
                        ...
                        if (Wx_SetMsgKey(MsgId))
                        {
                            ...
                            if (sub_type == 49)
                            {
                                ...
                                else if (content.IndexOf("微信转账") != -1)//当sub_type=49，并且content内容包含“微信转账”时，表示这是一笔微信转账通知
                                {
                                    Task.Factory.StartNew(delegate
                                    {
                                        fixed (int* WxUser1 = &pointerWxUser, pushStr1 = &pushStr)
                                        {
                                            XzyWxApis.WXTransferOperation(pointerWxUser, Newtonsoft.Json.JsonConvert.SerializeObject(msg), (IntPtr)pushStr1);
                            ...
                            else if (sub_type == 3 || sub_type == 47) //图片
                            {
                                Task.Factory.StartNew(delegate
                                {
                                    fixed (int* WxUser1 = &pointerWxUser, pushStr1 = &pushStr)
                                    {
                                        XzyWxApis.WXGetMsgImage(pointerWxUser, Newtonsoft.Json.JsonConvert.SerializeObject(msg), (IntPtr)pushStr1);
                            ...
                            else if (sub_type == 34)//34指语音消息，
                            {
                                Task.Factory.StartNew(delegate
                                {
                                    fixed (int* WxUser1 = &pointerWxUser, pushStr1 = &pushStr)
                                    {
                                        XzyWxApis.WXGetMsgVoice(pointerWxUser, Newtonsoft.Json.JsonConvert.SerializeObject(msg), (IntPtr)pushStr1);
                            ...
                            else if (sub_type == 43)//视频
                            {
                                Task.Factory.StartNew(delegate
                                {
                                    fixed (int* WxUser1 = &pointerWxUser, pushStr1 = &pushStr)
                                    {
                                        XzyWxApis.WXGetMsgVideo(pointerWxUser, Newtonsoft.Json.JsonConvert.SerializeObject(msg), (IntPtr)pushStr1);
                                        var datas23 = MarshalNativeToManaged((IntPtr)pushStr);
                                        var str23 = datas23.ToString();
                                        //取base64转码视频
        ...
        public unsafe List<WxMember> Wx_GetGroupMember(string groupId)
        {
            ...
            {
                XzyWxApis.WXGetChatRoomMember(pointerWxUser, groupId, (IntPtr)readmember1);
        ...
        public unsafe void Wx_IntoGroup(string url)
        {
            if (url != "")
            {
                ...
                {
                    XzyWxApis.WXGetRequestToken(pointerWxUser, "", url, (IntPtr)jinqun1);
        ...
        /// <param name="groupid"></param>
        /// <returns></returns>
        public unsafe string Wx_GetUserQRCode(string groupid)
        {
            var result = "";
            fixed (int* WxUser1 = &pointerWxUser, msgptr1 = &msgPtr)
            {
                XzyWxApis.WXGetUserQRCode(pointerWxUser, groupid,0,(IntPtr)msgptr1);
                var datas = MarshalNativeToManaged((IntPtr)msgPtr);
                result = datas.ToString();
                Wx_ReleaseEX(ref msgPtr);
            }
        ...
        public unsafe string Wx_SendMomentVideo() {
            fixed (int* WxUser1 = &pointerWxUser, msgptr1 = &msgPtr)
            {
                string media = "<media><id>0</id><type><![CDATA[6]]></type><title>微信协议认准https://github.com/changtuiqie/Mac.WeChat</title><description>微信协议认准https://github.com/changtuiqie/Mac.WeChat</description><private>0</private><url videomd5=\"6995da24874efc0f7d686775a8ac197d\" md5=\"8ab054629e395a0c9154e651778b5ba8\" type=\"1\"><![CDATA[http://shzjwxsns.video.qq.com/102/20202/snsvideodownload?filekey=30340201010420301e0201660402534804108ab054629e395a0c9154e651778b5ba8020327e344040d00000004627466730000000131&hy=SH&storeid=32303138313232373037353435393030303530623030383539333438616233393730333730613030303030303636&dotrans=2&ef=15_0&bizid=1023]]></url><thumb type=\"1\"><![CDATA[http://vweixinthumb.tc.qq.com/150/20250/snsvideodownload?filekey=30340201010420301e02020096040253480410512c8c51aeb2ada3ac83f4dfa0ab1abb02022159040d00000004627466730000000131&hy=SH&storeid=32303138313232373037353435393030303365373138383539333438616233393730333730613030303030303936&bizid=1023]]></thumb><size height=\"200.0\" width=\"355.0\" totalSize=\"8537.0\"></size></media>";
                
                var result = String.Format(App.PYQContent, wxUser.wxid, media);
                msgPtr = EUtils.ESendSNSImage(pointerWxUser, result, "微信协议认准https://github.com/changtuiqie/Mac.WeChat");
                var datas = MarshalNativeToManaged((IntPtr)msgPtr);
                result = datas.ToString();
                Wx_ReleaseEX(ref msgPtr);
                return result;
        ...
        public unsafe string Wx_SnsUpload(string base64)
        {
            ...
            fixed (int* WxUser1 = &pointerWxUser, imptr1 = &wx_imptr)
            {
                try
                {
                    ...
                    if (data.Length > 0)
                    {
                        XzyWxApis.WXSnsUpload(pointerWxUser, data, data.Length, (IntPtr)imptr1);
                        var datas = MarshalNativeToManaged((IntPtr)wx_imptr);
                        result = datas.ToString();
                        Wx_ReleaseEX(ref wx_imptr);
                    }
        ...
        public unsafe void Wx_GetContacts()
        {
            ...
            fixed (int* WxUser1 = &pointerWxUser, resulttxl1 = &wx_resultContacts)
            {
                ...
                {
                    Thread.Sleep(200);
                    XzyWxApis.WXSyncContact(pointerWxUser, (IntPtr)(resulttxl1));
        ...
        public unsafe string Wx_AddUser(string  v1, string v2,int type,string context)
        {
            ...
            fixed (int* WxUser1 = &pointerWxUser, msgptr1 = &msgPtr)
            {
                XzyWxApis.WXAddUser(pointerWxUser, v1, v2, type,context, (IntPtr)msgptr1);
                var datas = MarshalNativeToManaged((IntPtr)msgPtr);
                result = datas.ToString();
                Wx_ReleaseEX(ref msgPtr);
            }
        ...
        public unsafe string Wx_WebSearch(string search)
        {
            ...
            fixed (int* WxUser1 = &pointerWxUser, msgptr1 = &msgPtr)
            {
                XzyWxApis.WXWebSearch(pointerWxUser, search, (IntPtr)msgptr1);
                var datas = MarshalNativeToManaged((IntPtr)msgPtr);
                result = datas.ToString();
                Wx_ReleaseEX(ref msgPtr);
            }
        ...
        /// <param name="context"></param>
        /// <returns></returns>
        public unsafe string Wx_SendXCX(string wxid, string context) {
            var result = "";
            fixed (int* WxUser1 = &pointerWxUser, msgptr1 = &msgPtr)
            {
                XzyWxApis.WXSendAppMsg(pointerWxUser, wxid, context, (IntPtr)msgptr1);
                var datas = MarshalNativeToManaged((IntPtr)msgPtr);
                result = datas.ToString();
                Wx_ReleaseEX(ref msgPtr);
            }
        ...
        public unsafe Dictionary<string, packitme> RedpackOK(string json, int Timestamp)
        {
            ...
            {
                XzyWxApis.WXReceiveRedPacket(pointerWxUser, json, (IntPtr)redpack1);
                ...
                #region 领取红包
                XzyWxApis.WXOpenRedPacket(pointerWxUser, json, key, (IntPtr)redpack1);
                if ((int)redpack1 == 0) { return null; }
                ...
                XzyWxApis.WXQueryRedPacket(pointerWxUser, json, 0, (IntPtr)redpack1);
                if ((int)redpack1 == 0) { return null; }
                    ...
                    if (redpackitem.HeadTitle != null)
                    {
                        ...
                        Bk2:;
                            ...
                            for (int i = 0; i < countpage + countpage; i++)
                            {
                                ...
                                XzyWxApis.WXQueryRedPacket(pointerWxUser, json, i, (IntPtr)redpack1);
                                if ((int)redpack1 == 0) { return null; }
